...
## Installing programs
```sh
sudo pacman -S git neovim firefox alacritty wezterm eza ttf-jetbrains-mono-nerd ttf-nerd-fonts-symbols-mono ripgrep fd npm fish starship yazi ffmpegthumbnailer unarchiver jq poppler fzf zoxide
```
## Installing yay
```sh
